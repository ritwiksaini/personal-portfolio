export const experience = [
  ...
  },
  {
    ...
    bullets: [
      'Developed investment theses on Nuclear Energy in India and Immersion Cooling, surfacing nuclear as India\'s cheapest firm power at ₹3.83/kWh vs. ₹5+/kWh for firmed renewables and expanding the pipeline with 3 qualified companies.',
  ...
  },
  {
    ...
    bullets: [
      'Replaced intuition-based mentor-mentee pairing with a structured, metrics-driven dashboard, driving a 24.8% improvement in match quality. Good system design beats good intentions.',
  ...
  },
  {
    ...
    bullets: [
      'Led architecture and delivery of a full-stack platform for a non-profit supporting student fundraisers, directing a 5-person team from spec to live product using React, Django, PostgreSQL, Docker, and AWS.',
    ],
  },
]
